...
2. Navigate to the Autoblogger settings page
3. Enter your license key from https://autoblogger.es (BASIC, PREMIUM, or ENTERPRISE tier)
...
2. Enter your license key from https://autoblogger.es in the settings form
...
= 2.0.0 =
Initial release of Autoblogger. Install and configure your license key to get started.
