...
class Autoblogger_AJAX_Handlers {
    ...
    public static function register() {
        // Settings
        add_action('wp_ajax_autoblogger_save_settings', array(__CLASS__, 'save_settings'));
        add_action('wp_ajax_autoblogger_activate_license', array(__CLASS__, 'activate_license'));
        add_action('wp_ajax_autoblogger_deactivate_license', array(__CLASS__, 'deactivate_license'));
        add_action('wp_ajax_autoblogger_test_license', array(__CLASS__, 'test_license'));
        add_action('wp_ajax_autoblogger_get_subscription', array(__CLASS__, 'get_subscription'));
        
        // Interview management
        add_action('wp_ajax_autoblogger_get_interviews_list', array(__CLASS__, 'get_interviews_list'));
        add_action('wp_ajax_autoblogger_get_interview', array(__CLASS__, 'get_interview'));
        add_action('wp_ajax_autoblogger_create_interview', array(__CLASS__, 'create_interview'));
        add_action('wp_ajax_autoblogger_update_interview', array(__CLASS__, 'update_interview'));
        add_action('wp_ajax_autoblogger_generate_script_text', array(__CLASS__, 'generate_script_text'));
    ...
    public static function save_settings() {
        ...
        Autoblogger_Settings::update_all($settings);
    ...
    public static function activate_license() {
        ...
        $response = Autoblogger_API_Client::activate_license($license_key, $site_url);
        $result = Autoblogger_API_Client::parse_response($response);

        if ($result['success']) {
            // Save license key and activate plugin
            Autoblogger_Settings::update('license_key', $license_key);
            Autoblogger_Settings::activate();
    ...
    public static function deactivate_license() {
        ...
        Autoblogger_Settings::deactivate();
    ...
    public static function test_license() {
        ...
        $response = Autoblogger_API_Client::validate_license($license_key);
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    public static function get_subscription() {
        ...
        $response = Autoblogger_API_Client::get_subscription();
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    public static function test_connection() {
        ...
        $response = Autoblogger_API_Client::test_connection();
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    public static function get_interviews_list() {
        ...
        $response = Autoblogger_API_Client::get_interviews_list();
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    public static function get_interview() {
        ...
        $response = Autoblogger_API_Client::get_interview($interview_id);
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    public static function get_post() {
        ...
        $response = Autoblogger_API_Client::get_post($post_id);
        $result = Autoblogger_API_Client::parse_response($response);
    ...
    private static function generate_index($blocks) {
        ...
        $index_content = '<!-- wp:group {"className":"autoblogger-index","layout":{"type":"constrained"}} -->' . "\n";
        $index_content .= '<div class="wp-block-group autoblogger-index">' . "\n";
        
        // Index title
        $index_content .= '<!-- wp:heading {"level":2} -->' . "\n";
        $index_content .= '<h2 class="wp-block-heading index-title">' . esc_html__('Table of Contents', 'autoblogger') . '</h2>' . "\n";
