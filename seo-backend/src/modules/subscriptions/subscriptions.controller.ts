...
export class SubscriptionsController {
  ...
  @ApiSecurity('bearer')
  @ApiOperation({
    summary: 'Get current subscription plan and usage (Session-based)',
    description:
      'Returns the current user subscription, billing period, and usage statistics. Requires Auth0 session token.',
  })
  @ApiResponse({
    status: 200,
